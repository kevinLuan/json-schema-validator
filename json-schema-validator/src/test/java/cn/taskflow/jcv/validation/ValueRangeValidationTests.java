...
public class ValueRangeValidationTests {
    ...
    public void test() {
        ...
        values.addAll(newArrayList("a", "b", "c"));
        values.addAll(newArrayList(true, false));
        values.addAll(newArrayList(0, 1, 2, 3, 4, 5));
        values.addAll(newArrayList(10.12f, 11.123f, 12.123f));
        values.addAll(newArrayList(2.123d, 3.1415926d));

        List<Object> excludeValues = new ArrayList<>();
        excludeValues.addAll(newArrayList("AA", "BB"));
        excludeValues.addAll(newArrayList(6, 7, 8));
        excludeValues.addAll(newArrayList(1101.12f, 1111.123f, 1112.123f));
        excludeValues.addAll(newArrayList(211.123d, 13.1415926d));
    ...
    private List<Object> newArrayList(Object... args) {
